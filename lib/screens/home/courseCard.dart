                  ...
                  children: [
                    Container(
                      padding: EdgeInsets.only(
                          left: cardSize * 0.05.w,
                          right: cardSize * 0.05.w,
                          top: cardSize * 0.05.h,
                          bottom: cardSize * 0.07.h),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          customText(context, 40.sp, FontWeight.bold,
                              Colors.white, this.course.title),
                          Expanded(
                            child: Container(
                              //height: cardSize*0.25,
                              // color: Colors.red,
                              child: Text(this.course.brief,
                          ...
                          customText(context, 32.sp, FontWeight.bold,
                              Colors.white, this.course.author),
                        ],
                      ),
                    ),
                    Positioned(
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.circular((cardSize * 0.2.h)),
                              boxShadow: [
                                BoxShadow(
